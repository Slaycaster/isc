        ...
        case 'getCroppedCanvas':
          if (result) {
            ...
            //var emp_id = "<?php $id ?>";
              ...
              //var url= "http://localhost/scorecard/public/employscropphoto/"+result;
              console.log(emp_id);
            if(emp_id == 0)
            {
              $.ajax({  
                type: "POST",
                url: "store/changephoto/processupload",
                data: { 
                   imgBase64: dataURL,
                ...
                //window.location.href = "employs/finishedupload";
                window.location.href =  "store/changephoto/finishedupload";
              });
            }
             else{ 
              ...
              $.ajax({
                type: "POST",
                url: "edit/changephoto/processuploadedit",
                data: { 
                   imgBase64: dataURL,
                   empID: emp_id
                }
                ...
                // and than put the image in your browser.
                //window.location.href = "employs/finishedupload";
              window.location.href =  "edit/changephoto/finisheduploadedit";
              });
            ...
            //if (!download.disabled) {
               ...
               //window.location.href = "employscropphoto/"+result;
