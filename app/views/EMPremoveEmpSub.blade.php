                        ...
                        <table id="example">
                          ...
                          <tbody>
                                ...
                                <td>
                                 ...
                                 <td>
                                      <a class = 'btn btn-warning' style= "margin-bottom:5px" href="{{ URL::to('EMPremoveEmpMeasure/' . $sub->id) }}" onclick="window.open('{{ URL::to('EMPremoveEmpMeasure/' . $sub->id) }}', 'newwindow'); return false;">Show its Measures</a>
                                </td>
