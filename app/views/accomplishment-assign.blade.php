...
<head>
    ...
    <title>Scorecard (Assign Targets) | PNP Scorecard System</title>

</head>

 {{ Form::open(array('url' => 'employee/accomplishment', 'method' => 'post', 'id' => 'formid')) }}

<div class="col-md-3">

</div>

<div class="col-md-6" style="margin-top:55px; margin-left:1%; background-color:white;  width:1118px; ">
   ...
   @endforeach
    ...
    <div class='col-md-12'>
      ...
      <div class='col-md-2' style='margin-bottom:10%'>
        ...
        <button type="button" class="btn btn-lg btn-success" style='text-align:left; font-size:15px; padding-top:10px; padding-bottom:10px; margin-bottom:3%; margin-left:-40px;' data-toggle="modal" data-target="#confirmModal">Save</button>
    ...
    <div id="confirmModal" class="modal fade" role="dialog">
      ...
      <!-- Modal content-->
        ...
        <div class="modal-body">
          <p><strong>NOTE:<br></strong>When your scorecard has already been submitted this week, activities that you'll add <strong>will be available next week</strong>.<br><br>So make sure <strong>your scorecard has all the activities for this week</strong> before you submit.<br><br>Continue?</p>
        </div>
        <div class="modal-footer">
          
          <!--<input class = 'btn btn-success' type="submit" value="Ok">-->

        {{ Form::submit('Ok', array('class' => 'btn btn-lg btn-success')) }}
