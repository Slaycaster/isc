       ...
       $EndDate = date("Y/m/d", strtotime($StartDate.'+'. $add_days . 'days')); 
        ...
        $tempMainActivity = '';
              ...
              $tempMeasure = '';
                ...
                //$this->Cell(40,5,'<h1>Hello</h1>',1,0,'C');
...
$pdf->Output('accomplishment_report.pdf');
?>

<br><br><iframe src="accomplishment_report.pdf" title="downloads"  height= "450" width="100%"  frameborder="0" margin-left= "100px" target="Message"></iframe>
