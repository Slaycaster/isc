...
<div class="container" style=" margin-bottom:5%">
	...
	<div class="label_white">
	  <div class="col-md-12" style="margin-top:-10px; margin-bottom:15px">
	    <h1>Set Measures - {{ $PersonnelName }}</h1>
	  </div>
	</div>
...
@if (Session::has('message'))
 ...
 {{ Form::open(array('url' => 'UAEpostsetemployeemeasure', 'method' => 'post')) }}
 ...
 {{ Form::open(array('url' => 'UAEpostsetemployeemeasure2', 'method' => 'post')) }}
...
{{ Form::open(array('url' => 'UAEposteditmeasure', 'method' => 'post')) }}
