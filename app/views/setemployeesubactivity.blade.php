...
<head>
    ...
    <title>Set Activities | PNP Scorecard System</title>
...
<div class="container" style=" margin-bottom:5%">
	...
	<div class="label_white">
	  <div class="col-md-12" style="margin-top:-10px; margin-bottom:15px">
	    <h1>Edit Sub Activities - {{ $PersonnelName }}</h1>
	  </div>
	</div>
...
<div class = "row">
 ...
 {{ Form::open(array('url' => 'postsetemployeesubactivity', 'method' => 'post')) }}
...
{{ Form::open(array('url' => 'posteditemployeesubactivity', 'method' => 'post')) }}
	                            ...
	                            <td>
	                              ...
	                              <div class="controls" style="margin-bottom:3px">
								    ...
								    @else
		                               ...
		                               {{ Form::input('button', 'state', 'Enable',array('id' =>'enable'.$counter, 'class' => 'btn btn-warning')) }}
...
$(document).on('click','#disable0',function(){
     ...
     $("#enable0").attr('class', 'btn btn-warning');
	...
	$(document).on('click','#disable1',function(){
     ...
     $("#enable1").attr('class', 'btn btn-warning');
	...
	$(document).on('click','#disable2',function(){
     ...
     $("#enable2").attr('class', 'btn btn-warning');
	...
	$(document).on('click','#disable3',function(){
     ...
     $("#enable3").attr('class', 'btn btn-warning');
	...
	$(document).on('click','#disable4',function(){
     ...
     $("#enable4").attr('class', 'btn btn-warning');
	...
	$(document).on('click','#disable5',function(){
     ...
     $("#enable5").attr('class', 'btn btn-warning');
	...
	$(document).on('click','#disable6',function(){
     ...
     $("#enable6").attr('class', 'btn btn-warning');
	...
	$(document).on('click','#disable7',function(){
     ...
     $("#enable7").attr('class', 'btn btn-warning');
	...
	$(document).on('click','#disable8',function(){
     ...
     $("#enable8").attr('class', 'btn btn-warning');
	...
	$(document).on('click','#disable9',function(){
     ...
     $("#enable9").attr('class', 'btn btn-warning');
	...
	$(document).on('click','#disable10',function(){
     ...
     $("#enable10").attr('class', 'btn btn-warning');
	...
	$(document).on('click','#disable11',function(){
     ...
     $("#enable11").attr('class', 'btn btn-warning');
...
<script type="text/javascript">
		...
		$('#edit0').click(function() {
		    ...
		    var input = $('<input style = "width: 760px; height: 40px" type="text" name="sub_activity[]" value="'+ text +'" />')

		    $('.text-info0').text('').append(input);

		    var text1 = $('.text-hidden0').text();

		    var input1 = $('<input style = "width: 760px; height: 40px" type="hidden" name="subactivity[]" value="'+ text1 +'" />')
