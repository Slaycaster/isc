      ...
      <div class="panel panel-default">
          ...
          @endif
              ...
              <div class="alert alert-warning"><h4 style= 'color:black; font-weight:bolder'>NOTE:</h4><p style= 'color:black;'>These are your activities which aren't placed in your scorecard yet, this means that your current and past scorecard records aren't affected whatsoever. You can safely remove these if you feel they're just typographical errors, irrelevant to your scorecard and such.
               <br><br>If you want to remove just the Main Activity's sub-activities instead, click "Show its Sub-activities" button to do so.</p> <hr>

                <p style= 'color:black;'>If you want to list all sub-activities/measures for removal instead, use the following buttons below:</p>
                <div class="col-md-6 btn btn-success"><a href="">List all Sub-activities</a></div>
                <div class="col-md-6 btn btn-success"><a href=""></a>List all Measures</div>
              </div><br>
         ...
         {{ Form::open(array('url' => 'employee/deletemain', 'method' => 'post')) }}
                        ...
                        <table id="example">
                          ...
                          <tbody>
                                ...
                                <td>
                                 ...
                                 <td>
                                      <a class = 'btn btn-warning' style= "margin-bottom:5px" href="{{ URL::to('removeEmpSub/' . $main->id) }}" onclick="window.open('{{ URL::to('removeEmpSub/' . $main->id) }}', 'newwindow'); return false;">Show its Sub-activities</a>
                                </td>
