...
<head>
    ...
    <title>Scorecard (Pending Target) | PNP Scorecard System</title>
...
<div class="col-md-12" style="margin-top:-10px; margin-bottom:15px; color:white;">
  ...
  <center><h1><strong>PENDING TARGET VALUES FOR APPROVAL</strong></h1></center>
  <center><h4><strong>( WAITING FOR SUPERVISOR'S APPROVAL)</strong></h4></center><hr>
...
@endif
    ...
    <div class='col-md-12'>
     ...
     <button type="button" class="btn btn-lg btn-success" style='text-align:left; font-size:15px; margin-bottom:70px;' data-toggle="modal" data-target="#confirmModal">Update Target Values</button>
