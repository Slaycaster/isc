...
<div class="container" style="margin-top:3%">
  ...
  <div class = "col-md-12">
      ...
      <div class="panel panel-default">
         ...
         {{ Form::open(array('url' => 'employee/uadeletesub', 'method' => 'post')) }}
                        ...
                        <table id="example">
                          ...
                          <tbody>
                                ...
                                <td>
                                 ...
                                 <td>
                                      <a class = 'btn btn-warning' style= "margin-bottom:5px" href="{{ URL::to('UAremoveEmpMeasure/' . $sub->id) }}" onclick="window.open('{{ URL::to('UAremoveEmpMeasure/' . $sub->id) }}', 'newwindow'); return false;">Show its Measures</a>
                                </td>
