...
<div class="container" style="margin-top:3%">
  ...
  <div class = "col-md-12">
      ...
      <div class="panel panel-default">
         ...
         {{ Form::open(array('url' => 'employee/EMPdeletemain', 'method' => 'post')) }}
                        ...
                        <table id="example">
                          ...
                          <tbody>
                                ...
                                <td>
                                 ...
                                 <td>
                                      <a class = 'btn btn-warning' style= "margin-bottom:5px" href="{{ URL::to('EMPremoveEmpSub/' . $main->id) }}" onclick="window.open('{{ URL::to('EMPremoveEmpSub/' . $main->id) }}', 'newwindow'); return false;">Show its Sub-activities</a>
                                </td>
