<?php
    ...
    $pendingSubmission = DB::table('target_approval')
...
<body>
	...
	<p style="text-align: center;">
		...
		<br>
		<normal style="font-size: 15px">{{ $unit_office->UnitOfficeName }}<br>{{ $unit_office_secondaries->UnitOfficeSecondaryName }}</normal>
		<br>
		<normal style="font-size: 10px">isc.pulis.net</normal>
		<br><br>
		<normal style="font-size: 15px">
			<strong>List of personnel with pending submission of scorecard</strong>
			<br>{{ $DateCovered }}
		</normal>
	</p>
	<br>
	...
	@if($pendingSubmission != null)
	    <table border="1">
			...
			<tbody>
			@foreach($pendingSubmission as $employee)
				<?php
					$UnitOfficesName = '';
