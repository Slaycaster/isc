...
<head>
    ...
    <title>Personnel's Other Activity | PNP Scorecard System</title>
...
<div class="container">
    ...
    <p style="font-size: 20px"><i>for this week - {{$other_activity->RankCode}} {{$other_activity->EmpLastName}}, {{$other_activity->EmpFirstName}}</i></p>
    @endforeach
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <div class="panel-body">
          ...
          {{ Form::open(array('url' => 'employee/postOtherActivities', 'method' => 'post')) }}
...
@if (Session::has('mes'))
    ...
    @endif
                            ...
                            {{ Form::text('sub_activity', Input::get('sub_activity'), array('placeholder' => 'Sub Activity','autocomplete' => 'off', 'class' => 'form-control')) }}
        ...
        <div class="panel-footer">
          ...
          {{ Form::submit('Create Sub-Activity', array('class' => 'btn btn-lg btn-success')) }}
...
{{ Form::open(array('url' => 'employee/postOtherScorecard', 'method' => 'post')) }}
   ...
   <div class = "col-md-12">
        ...
        <div class="panel panel-primary">
              ...
              <div class="panel-heading" id = "up">
                  ...
                  <strong>Existing Other Activities</strong>

              </div>
              <div class = "table-responsive">
             <div class="panel-body">
             	<p style="font-size: 15px">Please check if you want the sub-activity to appear in your scorecard for this week</p>
             	<p style="font-size: 15px"><i>NOTE: You will do this every time you want this sub-activity to appear in your scorecard</i></p>
              <table class="table" id="example">
                  ...
                  <thead>
                      ...
                      <tr class="filters">       
                          ...
                          <th>Other Sub-activity Name</th>

                          <th>Add/Remove to Scorecard</th>

                          <th>Edit Other Sub-activity</th>

                          <th>Edit Other Sub-activity's Measures</th>
	                  ...
	                  @foreach ($other_activities as $other)
	                        ...
	                        <tr>
	                            ...
	                            <td style='color:black'>
	                           		...
	                           		{{ Form::label('main_activity[]', $other->OtherActivitiesName,  array('class' =>'text-info'.$counter, 'style' => 'color:black'))}}
	                            ...
	                            <td>
	                              ...
	                              <div class="controls" style="margin-bottom:3px">
								        ...
								        {{ HTML::link('#up', 'Edit Sub-activity', array('id' => 'edit'.$counter, 'class' => 'btn btn-info'))}}
	                            ...
	                            <td>
								       ...
								       <a class = 'btn btn-warning' href="{{ URL::to('editOtherMeasures/' . $other->id) }}">Edit Measure</a>
    ...
    <div class='col-md-12'>
    	...
    	<div class='col-md-2'>
    		 ...
    		 <input class = 'btn btn-success' style='font-size:15px; padding-top:15px; padding-bottom:15px; margin-bottom: 30px' type="submit" name="Save" value="Apply to Scorecard">
