...
<div class="container" style=" margin-bottom:5%">
	...
	<div class="col-md-12" style="margin-top:2%; margin-bottom:15px">

			<center><h1>Scorecard - Edit Main Activities </h1></center>
...
{{ Form::open(array('url' => 'employee/editemployeemainactivity', 'method' => 'post')) }}
