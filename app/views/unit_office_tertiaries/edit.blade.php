...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        {{ Form::model($unit_office_tertiary, array('method' => 'PATCH', 'route' => array('unit_office_tertiaries.update', $unit_office_tertiary->id))) }}
            <fieldset>
                            <div class="row">
                                <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div style='color:black'>{{ Form::select('UnitOfficeSecondaryID', $secondary_unit_offices_id, Input::old('UnitOfficeSecondaryID'), array('class' => 'btn btn-default dropdown-toggle')) }}</div>
                                    </div>
