...
<h1>Scorecard - Add Sub-activity Measures</h1>
...
<div class="col-md-6">
   @if (Session::has('message'))
    ...
    @if (Session::has('messaged'))
      ...
      <div class="alert alert-danger">{{ Session::get('messaged') }}</div><br>
    ...
    <div class="col-md-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Create Measure</h3>
          ...
          {{Form::hidden('empid',$id)}}
                ...
                <div class="panel-body">
                    {{ Form::open(array('url' => 'employee/successfuladdmeasures', 'method' => 'post')) }}
