  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <div class="panel-body">
          ...
          {{ Form::open(array('url' => 'UAEotheractivity/postOtherActivities', 'method' => 'post')) }}
...
{{ Form::open(array('url' => 'UAEotheractivity/postOtherScorecard', 'method' => 'post')) }}
	                  ...
	                  @foreach ($other_activities as $other)
	                        ...
	                        <tr>
	                            ...
	                            <td>
								       ...
								       <a class = 'btn btn-warning' href="{{ URL::to('UAEeditOtherMeasures/' . $other->id) }}">Edit Measure</a>
