...
<div class="col-md-12" style="margin-top:-10px; margin-bottom:15px; color:white;">
   ...
   <center><h1><strong>REQUEST FOR TARGET APPROVAL</strong></h1></center>
  <center><h4><strong>( INPUT TARGETS FOR SUPERVISOR APPROVAL )</strong></h4></center><hr>
...
<div class="col-md-6" style="margin-left:1%; background-color:white;  width:1118px; ">
    ...
    @if (Session::has('message3'))
      ...
      <div class="alert alert-danger" style="margin-top:2%">{{ Session::get('message3') }}</div>
              ...
              <tr>
                            ...
                            @endif
                             ...
                             {{Form::hidden('measures[]', $emp_activity->MeasureID )}}
                               ...
                               <td style = "font-size:10px; text-align:center;" colspan=7>{{ Form::text('targets[]', Input::get('target[]'), array('placeholder' => '0','autocomplete' => 'off', 'size' => '2' )) }}</td>
                               ...
                               <td style = "font-size:10px" colspan=2>{{ Form::text('day1[]', Input::get('day1[]'), array('id' => '', 'class' =>'Calc'.$counter, 'placeholder' => '0','autocomplete' => 'off', 'size' => '1', 'disabled' => 'disabled')) }}</td>
                                ...
                                <td style = "font-size:10px" colspan=2>{{ Form::text('day7[]', Input::get('day7[]'), array('id' => '', 'class' =>'Calc'.$counter,'placeholder' => '0','autocomplete' => 'off', 'size' => '1', 'disabled' => 'disabled')) }}</td>
                                 ...
                                 <td style = "font-size:10px" colspan=2><span id="Totala{{$counter}}" class="panel"></span></td>
              ...
              <tr>
                            ...
                            @endif
                             ...
                             {{Form::hidden('othermeasures[]', $other_activity->OtherMeasureID )}}
                               ...
                               <td style = "font-size:10px" colspan=2>{{ Form::text('otherday1[]', Input::get('otherday1[]'), array('id' => '', 'class' =>'Calca'.$counter, 'placeholder' => '0','autocomplete' => 'off', 'size' => '1', 'disabled' => 'disabled')) }}</td>

                                <td style = "font-size:10px" colspan=2>{{ Form::text('otherday2[]', Input::get('otherday2[]'),  array('id' => '', 'class' =>'Calca'.$counter,'placeholder' => '0','autocomplete' => 'off', 'size' => '1', 'disabled' => 'disabled')) }}</td>

                                <td style = "font-size:10px" colspan=2>{{ Form::text('otherday3[]', Input::get('otherday3[]'), array('id' => '', 'class' =>'Calca'.$counter,'placeholder' => '0','autocomplete' => 'off', 'size' => '1', 'disabled' => 'disabled')) }}</td>

                                <td style = "font-size:10px" colspan=2>{{ Form::text('otherday4[]', Input::get('otherday4[]'), array('id' => '', 'class' =>'Calca'.$counter,'placeholder' => '0','autocomplete' => 'off', 'size' => '1', 'disabled' => 'disabled')) }}</td>

                                <td style = "font-size:10px" colspan=2>{{ Form::text('otherday5[]', Input::get('otherday5[]'), array('id' => '', 'class' =>'Calca'.$counter,'placeholder' => '0','autocomplete' => 'off', 'size' => '1', 'disabled' => 'disabled')) }}</td>

                                <td style = "font-size:10px" colspan=2>{{ Form::text('otherday6[]', Input::get('otherday6[]'), array('id' => '', 'class' =>'Calca'.$counter,'placeholder' => '0','autocomplete' => 'off', 'size' => '1', 'disabled' => 'disabled')) }}</td>

                                <td style = "font-size:10px" colspan=2>{{ Form::text('otherday7[]', Input::get('otherday7[]'), array('id' => '', 'class' =>'Calca'.$counter,'placeholder' => '0','autocomplete' => 'off', 'size' => '1', 'disabled' => 'disabled')) }}</td>
...
@endif
    ...
    <div class='col-md-12'>
      ...
      <button type="button" class="btn btn-lg btn-success" style='text-align:left; font-size:15px; margin-bottom:70px;' data-toggle="modal" data-target="#confirmModal">Submit Target Values for Approval</button> 
       <!-- Modal -->
    <div id="confirmModal" class="modal fade" role="dialog">
      ...
      <!-- Modal content-->
        ...
        <div class="modal-body">
           <p>The target values will be reflected to your supervisor immediately. <br>Continue?</p><br>
