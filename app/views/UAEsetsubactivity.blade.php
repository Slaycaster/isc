...
<div class="container" style=" margin-bottom:5%">
	...
	<div class="label_white">
	  <div class="col-md-12" style="margin-top:-10px; margin-bottom:15px">
	    <h1>Set Sub Activities - {{ $PersonnelName }}</h1>
	  </div>
	</div>
...
<div class = "row">
 ...
 {{ Form::open(array('url' => 'UAEpostsetemployeesubactivity', 'method' => 'post')) }}
...
{{ Form::open(array('url' => 'UAEposteditemployeesubactivity', 'method' => 'post')) }}
