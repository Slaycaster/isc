...
<head>
    ...
    <title>Personnel Activities | PNP Scorecard System</title>
	...
	<div class = "col-md-12">
      ...
      <div class="panel panel-default">
          ...
          @endif
             ...
             {{ Form::open(array('url' => 'postremovescorecard', 'method' => 'post')) }}
...
<script type="text/javascript">
  $(document).ready(function() {
      $('#personnels-table').DataTable({
          processing: true,
          serverSide: true,
          ajax: 'employeeactivities/tempdatatable',
          columns: 
          [
