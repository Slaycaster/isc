...
<head>
 ...
 {{ Form::open(array('url' => 'employee/accomplishment', 'method' => 'post')) }}
              ...
              <tr>
                            ...
                            @endif
                             ...
                             {{Form::hidden('measures[]', $emp_activity->MeasureID )}}
                               ...
                               <td style = "font-size:10px; text-align:center;" colspan=7>{{ Form::text('target[]', Input::get('target[]'), array('placeholder' => '0','autocomplete' => 'off', 'size' => '2' )) }}</td>
