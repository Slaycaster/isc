  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <div class="panel-body">
          ...
          {{ Form::open(array('url' => 'SUotheractivity/postOtherActivities', 'method' => 'post')) }}
...
{{ Form::open(array('url' => 'SUotheractivity/postOtherScorecard', 'method' => 'post')) }}
	                  ...
	                  @foreach ($other_activities as $other)
	                        ...
	                        <tr>
	                            ...
	                            <td>
								       ...
								       <a class = 'btn btn-warning' href="{{ URL::to('SUeditOtherMeasures/' . $other->id) }}">Edit Measure</a>
